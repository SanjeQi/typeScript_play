...
const removeFristThree = (a) => a.slice(3);
...
const extractFirstThreeArr = (a) => a.slice(0, 3);
...
const nthLastGroupArr = (a, n) => a.slice(-n);
...
const removeElemEqualToB = (a, b) => a.filter((el) => el !== b);
...
// Flatten array
//v1
const flattenArrs1 = (...arrays) => arrays.reduce((acc, cur) => {
    acc.concat(cur), [];
});
//v2
...
//v1
const sortArrByObjectPropertyB = (inputArr) => inputArr.sort((obj1, obj2) => obj1.b - obj2.b);
console.log(sortArrByObjectPropertyB([
    { a: 1, b: 2 },
    { a: 5, b: 4 },
]));
console.log(sortArrByObjectPropertyB([
...
//v2
const sortArrByObjectPropertyB2 = (arr) => arr.sort((obj1, obj2) => (obj1.b > obj2.b ? obj1 : obj2));
console.log(sortArrByObjectPropertyB([
    { a: 1, b: 2 },
    { a: 5, b: 4 },
]));
