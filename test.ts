...
console.log(Object.getOwnPropertyNames(person1)); //output::[]:: "fname" property  is NOT listed out --- because is a Symbol --need to use .getOwnPropertySymbols()
console.log(Object.getOwnPropertyNames(person2)); //output::['firstName']:: property is listed out

console.log(Object.getOwnPropertySymbols(person1)); //output::[Symbol()]
